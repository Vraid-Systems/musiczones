...
public interface ProgramConstants {
    ...
    public static final int allNodesPingInterval = 25; //number of seconds between existance notify
    public static final int allNodesExpireInterval = 15; //seconds before node record allowed to be overwritten
    public static final int allNodesHardExpire = 60; //second before node is considered offline
    //jetty web server
